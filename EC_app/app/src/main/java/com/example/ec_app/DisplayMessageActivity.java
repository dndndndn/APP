...
public class DisplayMessageActivity extends AppCompatActivity {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 0x001:
                    ...
                    Toast.makeText(DisplayMessageActivity.this, "图片加载完毕", Toast.LENGTH_SHORT).show();
                    break;
                case 0x002:
                    hideAllWidget();
                    scroll.setVisibility(View.VISIBLE);
                    txtshow.setText(detail);
                    Toast.makeText(DisplayMessageActivity.this, "HTML代码加载完毕", Toast.LENGTH_SHORT).show();
                    break;
                case 0x003:
                    hideAllWidget();
                    webView.setVisibility(View.VISIBLE);
                    webView.loadDataWithBaseURL("", detail, "text/html", "UTF-8", "");
                    Toast.makeText(DisplayMessageActivity.this, "网页加载完毕", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.three:
                if (detail.equals("")) {
                    Toast.makeText(DisplayMessageActivity.this, "先请求HTML先嘛~", Toast.LENGTH_SHORT).show();
                } else {
